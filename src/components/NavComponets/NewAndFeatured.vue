...
<template>
    <div class="bg-white w-full h-auto">
        <div class="flex justify-center items-start py-8 h-full ">
            <ul class="flex space-x-6 md:space-x-12 lg:space-x-20">
                <li><!-- Change To Router -->
                ...
                <li>
                    <span class="font-semibold mb-2 inline-block">Shop Icons</span>
                ...
                <li>
                    <span class="font-semibold mb-2 inline-block">Jordan</span>
