    ...
    <div v-if="showHam">
        ...
        <div class="absolute top-0 right-0 w-[320px] h-full bg-white z-100 overflow-y-scroll">
            ...
            <div class="h-full flex flex-col pl-8 pr-6 py-4 justify-start items-start "><!-- HIDDEN-->
                ...
                <ul class="w-full mt-12 translate-x-[-6px]">
                    <li class="flex mb-4 ">
                        <a href="">
                            <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" role="img" width="30"
                                height="30" fill="none">
                    ...
                    <li class="flex">
                        <a href="">
                            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30"
                                viewBox="-16.71 -23.5 144.82 141">
                                <path
                                    d="M19.3 36.7L0 30.4 12.1 47 .2 63.5l19.1-6.3 11.6 16.6V53.3L50.4 47l-19.5-6.4V20.2z" />
                                <path d="M74.7 47L31.9 94h36.7l42.8-47L68.6 0H31.9z" />
                            </svg>
                        </a>
                        <span class="ml-2">Converse</span>
                    </li>
                </ul>
                ...
                <ul class="w-full mt-16 pb-[120px] translate-x-[-6px]">
                    <li class="mb-4">
                        <a href="" class="flex">
                            <svg aria-hidden="true" class="nav-icon mr-2" focusable="false" viewBox="0 0 24 24"
                    ...
                    <li class="mb-4">
                        <a href="" class="flex">
                            <svg aria-hidden="true" class="mr-2" focusable="false" viewBox="0 0 24 24" role="img"
